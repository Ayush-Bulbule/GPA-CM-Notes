//Write C program to Determine roots of given algebric equations using Bisection Method.
...
void main()
{
    ...
    printf("The solution does not coverage or iterations are not sufficient");
    return 1;
}
